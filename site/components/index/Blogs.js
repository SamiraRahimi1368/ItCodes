        ...
        >
            {
                ...
                >
                    <img className="mx-auto w-full object-cover  rounded-lg	 mx-auto "
                    ...
                    <a className='pt-6 p-1 text-center md:text-left text-cyan-700  display: inline-block text-sm	'> {blog.author}
                    ...
                    <a className='text-slate-900  display: inline-block text-cyan-700 text-sm	'> {blog._updatedAt}
                    </a>
...
'                   > {blog.message} </h3>
                    <a className="m-10 text-neutral-500 hover:text-sky-700 font-bold "> Read More</a>
